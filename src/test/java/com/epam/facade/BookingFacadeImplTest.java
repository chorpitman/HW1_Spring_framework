...
//        mockAccountService.rechargeAccountByAccountId(userAccount.getId(), rechargeBalance);
        //todo mock void method
        doNothing().when(mockAccountService).rechargeAccountByAccountId(userAccount.getId(), rechargeBalance);
